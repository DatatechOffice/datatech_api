...
public class Cadastro {
	...
	private JPasswordField Senha_1;
	private JPasswordField Senha_2;
	...
	private void initialize() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(!textField_Usuario.getText().equals("") &&
						!Senha_1.getText().equals("") &&
						!Senha_2.getText().equals("") &&
						!textField_Email.getText().equals("")) {
					
					//chamando a classe usuario atraves de um objeto
					Usuario usuario = new Usuario(textField_Usuario.getText(), Senha_1.getText(), Senha_2.getText(), textField_Email.getText());
		...
		Senha_1 = new JPasswordField();
		Senha_1.setBounds(245, 186, 300, 29);
		frmCadastro.getContentPane().add(Senha_1);
		
		Senha_2 = new JPasswordField();
		Senha_2.setBounds(245, 275, 300, 29);
		frmCadastro.getContentPane().add(Senha_2);
