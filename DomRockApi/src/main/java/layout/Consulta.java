...
public class Consulta {
	...
	private void initialize() {
		...
		//<------------------------------BOTﾃO PARA CONSULTAR CLIENTE NO BANCO------------------------------>
		...
		//<------------------------------FINAL DO BOTﾃO PARA CONSULTAR CLIENTE NO BANCO------------------------------>
		
		//<------------------------------BOTﾃO PARA ALTERAR OS CAMPOS DE CONSULTA------------------------------>
		...
		//<------------------------------FINAL BOTﾃO PARA ALTERAR OS CAMPOS DE CONSULTA------------------------------>

		//<------------------------------BOTﾃO PARA DELETAR UM CLIENTE------------------------------>
		btn_Deletar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				
				//DELETE ENTIDADE ONDE O CNPJ ﾉ IGUAL
			}
		});
		//<------------------------------FINAL BOTﾃO PARA DELETAR O CLIENTE------------------------------>
