		...
		vSolucao_NxtDemand.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(vSolucao_NxtDemand.isSelected()) {
					...
					//os produtos do Nxt Operations são deselecionados
		...
		vSolucao_NxtOperations.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(vSolucao_NxtOperations.isSelected()) {
					...
					//os produtos do Nxt Demand são deselecionados
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(!textField_vNomeCliente.getText().equals("") &&
					...
					//<------------------------------começo dos set da tela escopo nos atributos------------------------------>
					//criando o objeto cliente para setar as informações da tela
					...
					//setando o nome de razão social ao qual a empresa é aderida
					c1.setvSocial_Cliente(textField_vRazaoSocial.getText());
					
					//setando o setor do nosso cliente
					c1.setvSetor_Cliente(null);
					
					//um if para selecionar e setar qual a solução que o cliente esta ligada
					//se NxtDemand for selecionado entao setamos NxtDemand na variavel
					if(vSolucao_NxtDemand.isSelected()) {
						c1.setvSolucao_Cliente("NxtDemand");
					}
					//caso o contrario como so temos duas opções então se nxtdemand n for selecionado automaticamente tem que ser nxtoperations
					else {
					...
					//<------------------------------fim do sett de informações da tela------------------------------>
