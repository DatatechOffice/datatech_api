...
public class Escopo4 {

	private JFrame frmEscopo4;
	...
	public void setFrmEscopo4(JFrame frmEscopo4) {
		this.frmEscopo4 = frmEscopo4;
	}
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					window.frmEscopo4.setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	...
	private void initialize() {
		frmEscopo4 = new JFrame();
		frmEscopo4.setTitle("Escopo");
		frmEscopo4.getContentPane().setBackground(SystemColor.windowBorder);
		frmEscopo4.getContentPane().setLayout(null);
				
		JLabel lblNewLabel = new JLabel("Nome do Cliente:");
		lblNewLabel.setForeground(Color.WHITE);
		lblNewLabel.setFont(new Font("Arial", Font.BOLD, 20));
		lblNewLabel.setBounds(10, 10, 200, 20);
		frmEscopo4.getContentPane().add(lblNewLabel);
		...
		frmEscopo4.getContentPane().add(textField_vNomeCliente);
		...
		frmEscopo4.getContentPane().add(lblCpfcnpj);
		...
		frmEscopo4.getContentPane().add(comboBox_vEstabalecimento);
		...
		frmEscopo4.getContentPane().add(lblSolucao);
		...
		frmEscopo4.getContentPane().add(vSolucao_NxtDemand);
		...
		frmEscopo4.getContentPane().add(vSolucao_NxtOperations);
		frmEscopo4.setBounds(100, 100, 800, 600);
		frmEscopo4.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		...
		frmEscopo4.getContentPane().add(lblObjetivo);
		...
		frmEscopo4.getContentPane().add(vProduto_Vox);
		...
		frmEscopo4.getContentPane().add(vProduto_Optimization);
		...
		frmEscopo4.getContentPane().add(vProduto_Matching);
		...
		frmEscopo4.getContentPane().add(vProduto_Sales);
		...
		frmEscopo4.getContentPane().add(vProduto_Marketing);
		...
		frmEscopo4.getContentPane().add(vProduto_Pricing);
		...
		frmEscopo4.getContentPane().add(lblRazoSocial);
		...
		frmEscopo4.getContentPane().add(textField_vRazaoSocial);
		
		JButton btnNewButton = new JButton("Avan\u00E7ar");
		btnNewButton.setFont(new Font("Arial", Font.BOLD, 15));
		btnNewButton.setBounds(300, 500, 150, 30);
		frmEscopo4.getContentPane().add(btnNewButton);
		...
		frmEscopo4.getContentPane().add(lblEntragasPossiveis);
		...
		frmEscopo4.getContentPane().add(lblEntregasMinimas);
		...
		frmEscopo4.getContentPane().add(textArea_EntregaP);
