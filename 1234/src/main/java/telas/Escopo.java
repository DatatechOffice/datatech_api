	...
	private void initialize() {
		...
		vSolucao_NxtOperations.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(vSolucao_NxtOperations.isSelected()) {
					...
					//Os produtos s縊 desselecionados
		...
		btnNewButton_Prosseguir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				//Adicionando na array de produtos as op鋏es de NxtDemand
				...
				//Adicionando na array de produtos as op鋏es de Operations
				...
				// Mostrar as informa鋏es da ativa軋o na tela
				
				
				//lista para armazenar v疵ias pessoas
				
				//se houver dados para prosseguir
				//armazenando a solu鈬o selecionado
				...
				if(!textField_vCliente.getText().equals("") &&
						...
						vProList.size() != 0)
				{
					// um objeto pessoa � criado
					c1=new Cliente(textField_vCliente.getText());
					
					//salvando a solu鈬o selecionada no atributo do cliente
					if(vSolucao_NxtDemand.isSelected()) {
					...
					//Criando as op鋏es do alerta
					Object[] options = { "Confirmar", "Cancelar" };
					int retorno=JOptionPane.showOptionDialog(null, "Cliente: "+c1.getvCliente()+"\n"+
															"Solu鈬o: "+c1.getvSolucao()+"\n"+
															"Objetivo: "+c1.getvObjetivo()+"\n"+
															"Entregas Minimas: "+c1.getvEntregaM()+"\n"+
															"Entregas Possiveis: "+c1.getvEntregaP()+"\n"+
															"Produtos Selecionados:"+vProList+"\n"+
															"Voc� deseja continuar: ", "Informa鈬o", JOptionPane.DEFAULT_OPTION, JOptionPane.QUESTION_MESSAGE, null, options, options[0]);
					
					//Definindo as a鋏es do alerta
					
					//Se o us俉rio confirma segue para a proxima etap
					if(retorno == 0){
				...
				//Se houver um campo vazio o programa n縊 continua
				else {
