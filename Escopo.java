...
public class Escopo {
	...
	private void initialize() {
		...
		//	//<------------------------------ADICIONADO AO GRUPO DE RADIOS AS OPÇÕES QUE NÃO PODEM SE REPETIR------------------------------>
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(!textField_vNomeCliente.getText().equals("") &&
					...
					//<------------------------------CRIANDO O OBJETO PARA SER AS INFORMAÇÕES DA TELA------------------------------>
					...
					//<------------------------------SETTANDO O NOME DE RAZÃO SOCIAL DA EMPRESA------------------------------>
					...
					//<------------------------------UM IF PARA SELECIONAR QUAL SOLUÇÃO ESTAMOS ATRIBUINDO O CLIENTE------------------------------>
					//<------------------------------SE NXTDEMAND ESTÁ SELECIONADO ENTÃO ATRIBUIMOS ELA A VARIAVEL------------------------------>
					if(vSolucao_NxtDemand.isSelected()) {
						c1.setvSolucao_Cliente("NxtDemand");
					}
					//<------------------------------DO CONTRARIO TEMOS APENAS UMA SEGUNDA OPÇÃO ENTÃO COM ELSE JA RESOLVEMOS------------------------------>
					else {
					...
					//<------------------------------FIM DO SETT DE INFORMAÇÕES DA TELA ESCOPO------------------------------>
