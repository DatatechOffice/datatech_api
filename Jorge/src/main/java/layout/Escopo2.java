...
public class Escopo2 {
	...
	public JFrame getFrmEscopo2() {
		return frmEscopo2;
	}

	public void setFrmEscopo(JFrame frmEscopo2) {
		this.frmEscopo2 = frmEscopo2;
	}
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					window.frmEscopo2.setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	...
	private void initialize() {
		frmEscopo2 = new JFrame();
		frmEscopo2.setTitle("Escopo");
		frmEscopo2.getContentPane().setBackground(SystemColor.windowBorder);
		frmEscopo2.getContentPane().setLayout(null);
				
		JLabel lblNewLabel = new JLabel("Nome do Cliente:");
		lblNewLabel.setForeground(Color.WHITE);
		lblNewLabel.setFont(new Font("Arial", Font.BOLD, 20));
		lblNewLabel.setBounds(10, 10, 200, 20);
		frmEscopo2.getContentPane().add(lblNewLabel);
		...
		frmEscopo2.getContentPane().add(textField_vNomeCliente);
		...
		frmEscopo2.getContentPane().add(lblCpfcnpj);
		...
		frmEscopo2.getContentPane().add(textField_vCNPJ);
		...
		frmEscopo2.getContentPane().add(lblSolucao);
		...
		frmEscopo2.getContentPane().add(vSolucao_NxtDemand);
		...
		frmEscopo2.getContentPane().add(vSolucao_NxtOperations);
		frmEscopo2.setBounds(100, 100, 800, 600);
		frmEscopo2.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		...
		frmEscopo2.getContentPane().add(lblObjetivo);
		...
		frmEscopo2.getContentPane().add(vProduto_Vox);
		...
		frmEscopo2.getContentPane().add(vProduto_Optimization);
		...
		frmEscopo2.getContentPane().add(vProduto_Matching);
		...
		frmEscopo2.getContentPane().add(vProduto_Sales);
		...
		frmEscopo2.getContentPane().add(vProduto_Marketing);
		...
		frmEscopo2.getContentPane().add(vProduto_Pricing);
		...
		frmEscopo2.getContentPane().add(lblRazoSocial);
		...
		frmEscopo2.getContentPane().add(textField_vRazaoSocial);
		...
		frmEscopo2.getContentPane().add(lblEntragasPossiveis);
		...
		frmEscopo2.getContentPane().add(lblEntregasMinimas);
		...
		frmEscopo2.getContentPane().add(textArea_EntregaP);
