...
public class DaoSilver {
		...
		try {
			if (p1.getvId_Produto() != c1.getvId_Produto()) {
				if (e1.getvEnvio() != d1.getvEnvio()) {
					...
					con = ConnectionManager.getConnection();
					String select_sql = "select * from silver where cnpj=? and id_cliente=? and id_produto=? and forma_envio=? and id_dados=?";// where
																																				// cnpj
																																				// =
																																				// ?
					PreparedStatement pst;
					...
					while (rs.next()) {
						...
						/*
						 * if(d1.getvId_Dados() == 1) { t1.setvId_Dados(1); } if(d1.getvId_Dados() == 2)
						 * { t2.setvId_Dados(2); } if(d1.getvId_Dados() == 3) { t3.setvId_Dados(3); }
						 * 
						 * if(d1.getvId_Dados() == 4) { t4.setvId_Dados(4); }
						 * 
						 * if(d1.getvId_Dados() == 5) { t5.setvId_Dados(5); }
						 * 
						 * if(d1.getvId_Dados() == 6) { t6.setvId_Dados(6); }
						 * 
						 * if(d1.getvId_Dados() == 7) { t7.setvId_Dados(7); } }
						 */
	...
	public void atualizarSOk() {
		Connection con = null;
		try {
			if ((d1.getvId_Dados() == 1) || (d1.getvId_Dados() == 2) || (d1.getvId_Dados() == 3)
					|| (d1.getvId_Dados() == 4) || (d1.getvId_Dados() == 5) || (d1.getvId_Dados() == 6)
					|| (d1.getvId_Dados() == 7)) {
				con = ConnectionManager.getConnection();
				...
				pst.setObject(1, c1.getvCNPJ_Cliente());
				pst.setObject(2, c1.getvId_Cliente());
				pst.setObject(3, d1.getvId_Dados());
				int rowsUpdated = pst.executeUpdate();
				if (rowsUpdated > 0) {
					System.out.println("Id_Dados= " + d1.getvId_Dados());
				}
			} else {
				if ((d1.getvId_Dados() != 1) || (d1.getvId_Dados() != 2) || (d1.getvId_Dados() != 3)
						|| (d1.getvId_Dados() != 4) || (d1.getvId_Dados() != 5) || (d1.getvId_Dados() != 6)
