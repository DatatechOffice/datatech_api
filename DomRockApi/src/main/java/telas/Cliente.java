...
public class Cliente {
	...
	public Cliente(String vCliente) {
	  ...
	  public Cliente(String vCliente, String vSolucao, String vObjetivo, String
	  vEntregaM, String vEntregaP, String vEnvio, Object vPrazo) {
	  
	  this.vCliente_Nome = vCliente; this.vSolucao = vSolucao; this.vObjetivo =
	  vObjetivo; this.vEntregaM = vEntregaM; this.vEntregaP = vEntregaP;
	  this.vEnvio = vEnvio; this.vPrazo = vPrazo;
