...
public class Escopo3 {

	private JFrame frmEscopo3;
	...
	public JFrame getFrmEscopo3() {
		return frmEscopo3;
	}

	public void setFrmEscopo(JFrame frmEscopo) {
		this.frmEscopo3 = frmEscopo;
	}
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					window.frmEscopo3.setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	...
	private void initialize() {
		frmEscopo3 = new JFrame();
		frmEscopo3.setTitle("Escopo");
		frmEscopo3.getContentPane().setBackground(SystemColor.windowBorder);
		frmEscopo3.getContentPane().setLayout(null);
				
		JLabel lblNewLabel = new JLabel("Nome do Cliente:");
		lblNewLabel.setForeground(Color.WHITE);
		lblNewLabel.setFont(new Font("Arial", Font.BOLD, 20));
		lblNewLabel.setBounds(10, 10, 200, 20);
		frmEscopo3.getContentPane().add(lblNewLabel);
		...
		frmEscopo3.getContentPane().add(textField_vNomeCliente);
		...
		frmEscopo3.getContentPane().add(lblCpfcnpj);
		...
		frmEscopo3.getContentPane().add(comboBox_vEstabalecimento);
		...
		frmEscopo3.getContentPane().add(lblSolucao);
		...
		frmEscopo3.getContentPane().add(vSolucao_NxtDemand);
		...
		frmEscopo3.getContentPane().add(vSolucao_NxtOperations);
		frmEscopo3.setBounds(100, 100, 800, 600);
		frmEscopo3.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		...
		frmEscopo3.getContentPane().add(lblObjetivo);
		...
		frmEscopo3.getContentPane().add(vProduto_Vox);
		...
		frmEscopo3.getContentPane().add(vProduto_Optimization);
		...
		frmEscopo3.getContentPane().add(vProduto_Matching);
		...
		frmEscopo3.getContentPane().add(vProduto_Sales);
		...
		frmEscopo3.getContentPane().add(vProduto_Marketing);
		...
		frmEscopo3.getContentPane().add(vProduto_Pricing);
		...
		frmEscopo3.getContentPane().add(lblRazoSocial);
		...
		frmEscopo3.getContentPane().add(textField_vRazaoSocial);
		
		JButton btnNewButton = new JButton("Avan\u00E7ar");
		btnNewButton.setFont(new Font("Arial", Font.BOLD, 15));
		btnNewButton.setBounds(300, 500, 150, 30);
		frmEscopo3.getContentPane().add(btnNewButton);
		...
		frmEscopo3.getContentPane().add(lblEntragasPossiveis);
		...
		frmEscopo3.getContentPane().add(lblEntregasMinimas);
		...
		frmEscopo3.getContentPane().add(textArea_EntregaP);
		...
		frmEscopo3.getContentPane().add(textArea_EntregaM);
