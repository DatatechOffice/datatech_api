...
public class DaoSilver {
	...
	public DaoSilver(Cliente c1, Cliente p1, Cliente p2, Cliente p3, Cliente p4, Cliente p5, Cliente p6, Dados e1, Dados e2, Dados e3, Dados d1,
			Dados t1, Dados t2, Dados t3, Dados t4, Dados t5, Dados t6, Dados t7, int contador) {
		this.c1=c1;
		this.p1 = p1;
		this.p2 = p2;
		this.p3 = p3;
	...
	public List<Cliente> buscarSilverDados1() {
        ...
        try {
            ...
            while(rs.next()) {
            	...
            	System.out.println(contador + " " + d1.getvId_Dados());
            	}
            }
            }
        } catch (SQLException e) {
