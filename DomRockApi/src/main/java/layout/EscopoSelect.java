...
public class EscopoSelect {

	private JFrame frmEscopoSelect;
	...
	public void setFrmEscopo(JFrame frmEscopoSelect) {
		this.frmEscopoSelect = frmEscopoSelect;
	}
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					window.frmEscopoSelect.setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	...
	private void initialize() {
		frmEscopoSelect = new JFrame();
		frmEscopoSelect.setTitle("Escopo");
		frmEscopoSelect.getContentPane().setBackground(SystemColor.windowBorder);
		frmEscopoSelect.getContentPane().setLayout(null);
				
		JLabel lblNewLabel = new JLabel("Nome do Cliente:");
		lblNewLabel.setForeground(Color.WHITE);
		lblNewLabel.setFont(new Font("Arial", Font.BOLD, 20));
		lblNewLabel.setBounds(10, 10, 200, 20);
		frmEscopoSelect.getContentPane().add(lblNewLabel);
		...
		frmEscopoSelect.getContentPane().add(textField_vNomeCliente);
		...
		frmEscopoSelect.getContentPane().add(lblCpfcnpj);
		...
		frmEscopoSelect.getContentPane().add(comboBox_vEstabalecimento);
		...
		frmEscopoSelect.getContentPane().add(lblSolucao);
		...
		frmEscopoSelect.getContentPane().add(vSolucao_NxtDemand);
		...
		frmEscopoSelect.getContentPane().add(vSolucao_NxtOperations);
		frmEscopoSelect.setBounds(100, 100, 800, 600);
		frmEscopoSelect.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		...
		frmEscopoSelect.getContentPane().add(lblObjetivo);
		...
		frmEscopoSelect.getContentPane().add(textField_vObjetivo);
		
		JLabel lblProdutos = new JLabel("Produtos:");
		lblProdutos.setForeground(Color.WHITE);
		lblProdutos.setFont(new Font("Arial", Font.BOLD, 20));
		lblProdutos.setBounds(440, 10, 200, 20);
		frmEscopoSelect.getContentPane().add(lblProdutos);
		...
		frmEscopoSelect.getContentPane().add(vProduto_Vox);
		...
		frmEscopoSelect.getContentPane().add(vProduto_Optimization);
		...
		frmEscopoSelect.getContentPane().add(vProduto_Matching);
		...
		frmEscopoSelect.getContentPane().add(vProduto_Sales);
		...
		frmEscopoSelect.getContentPane().add(vProduto_Marketing);
		...
		frmEscopoSelect.getContentPane().add(vProduto_Pricing);
		...
		frmEscopoSelect.getContentPane().add(lblRazoSocial);
		...
		frmEscopoSelect.getContentPane().add(textField_vRazaoSocial);
		...
		frmEscopoSelect.getContentPane().add(lblEntragasPossiveis);
		...
		frmEscopoSelect.getContentPane().add(lblEntregasMinimas);
		...
		frmEscopoSelect.getContentPane().add(textArea_EntregaP);
		...
		frmEscopoSelect.getContentPane().add(textArea_EntregaM);
		...
		frmEscopoSelect.getContentPane().add(btnRetornar);
